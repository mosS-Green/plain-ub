...
from app.plugins.ai.media import handle_audio
...
async def transcribe(bot: BOT, callback_query: CallbackQuery):
    ...
    transcribed_str = await handle_audio(prompt="Transcribe this audio. Use english alphabet to express irrespective of language. Do not translate. Do not write anything extra than the transcription. Have good formatting. Use english alphabet.", message=callback_query.message.reply_to_message, model=MEDIA_MODEL)
